Feature: Configuring the container and retrieving an object
  ...
  Scenario: Retrieving an object from the container
    ...
    When I get the service 'class-with-one-dependency' out of the container
    Then the result should be an instance of '\DirtyNeedle\TestFixtures\NestedDependencies\ClassWithOneDependency'
